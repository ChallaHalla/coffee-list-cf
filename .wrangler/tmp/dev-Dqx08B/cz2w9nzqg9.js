// .wrangler/tmp/bundle-ZpYrO1/checked-fetch.js
...
// .wrangler/tmp/pages-EisxDa/bundledWorker-0.8466444031826124.mjs
  ...
  function we(e, t) {
    ...
    for (var r = {}, s = t || {}, a = s.decode || ve, i = 0; i < e.length; ) {
      ...
      if (r[c] === void 0) {
        ...
        u.charCodeAt(0) === 34 && (u = u.slice(1, -1)), r[c] = be(u, a);
      }
      i = o + 1;
    }
    return r;
...
function N(e, t, r) {
  let { match: s, captureGroupKeys: a } = b(e, t);
...
async function C(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = S(await r.fetch(I(c, e.path ?? a))), e.headers && R(n.headers, e.headers);
        break;
      }
      case "static": {
...
var k = class {
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: s, cookie: a } } = t, i = a && this.cookies[a], n = H(i ?? ""), o = H(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...n, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (p) {
...
// .wrangler/tmp/pages-EisxDa/cz2w9nzqg9.js
...
// .wrangler/tmp/bundle-ZpYrO1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZpYrO1/middleware-loader.entry.ts
